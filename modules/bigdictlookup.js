...
export default function bigdictlookup(instance, popup, lang, originalform, lemma) {
    ...
    var uri;
    if (lang == "grc") {
        uri = "https://repos1.alpheios.net/exist/rest/db/xq/lexi-get.xq?lx=lsj&lg=grc&out=HTML&l=" + lemma;
    } else if (lang == "lat") {
        ...
        if (Object.prototype.toString.call(splitlemma) === '[object Array]') {
            ...
            uri = "https://repos1.alpheios.net/exist/rest/db/xq/lexi-get.xq?lx=ls&lg=lat&out=HTML" + lemmas;
        } else {
            uri = "https://repos1.alpheios.net/exist/rest/db/xq/lexi-get.xq?lx=ls&lg=lat&out=HTML&l=" + lemma
        }

    } else if (lang == "ara") {
        uri = "https://repos1.alpheios.net/exist/rest/db/xq/lexi-get.xq?lx=sal&lg=ara&out=HTML&l=" + lemma;
    } else if (lang == "per") {
        uri = "https://repos1.alpheios.net/exist/rest/db/xq/lexi-get.xq?lx=stg&lg=per&out=HTML&l=" + lemma;
    }
    async(uri, "GET", "html", function (result) {
        ...
        if(lang == "grc"){
            uri = "https://repos1.alpheios.net/exist/rest/db/xq/lexi-get.xq?lx=ml&lg=grc&out=HTML&l=" + lemma;

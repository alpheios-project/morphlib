...
Additional advanced functionality wouldmay follow, such as:
...
By developing the libraries from the outside to support multiple projects, we also hope to help ensure their sustainability.  We will build them as a collaborative community of projects and developers working together to enhance and maintain the code.
